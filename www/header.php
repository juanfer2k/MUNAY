...
<span class="icon">🌙</span> <span class="label" id="themeLabel">Día</span>
    <base href="/MUNAY/www/">
    <!-- Cargar ambos archivos CSS -->
    <link rel="stylesheet" href="css/style.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="css/panel_roles_styles.css?v=<?php echo time(); ?>">
    <style>
...
<header class="app-header">
    ...
    ?>
        ...
        <button id="nightModeToggle" class="night-toggle" title="Alternar modo noche">
            <span class="icon">☀</span> <span class="label">Día</span>
        </button>
